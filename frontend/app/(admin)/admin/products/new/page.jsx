...
import { ArrowLeft, Package, IndianRupee, Hash, FileText, Tag, Image } from 'lucide-react'
    ...
    <AdminLayout>
      <div className="max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-medical-blue mb-2">Add New Product</h1>
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            <button
              type="submit"
              disabled={loading}
              className="bg-brand-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-brand-700 transition-all shadow-premium disabled:opacity-50 disabled:cursor-not-allowed"
            >
